				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="menuName"
							placeholder="请输入菜单名称" value="${menu.menuName }" />
					</div>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="parentMenuId" class="form-control">
							...
							<option value="${me.menuId }" ${me.menuId==menu.parentMenuId?'selected':'' } >${me.menuName }</option>
							</c:forEach>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" name="menuUrl"
							placeholder="请输入菜单地址" value="${menu.menuUrl }" />
					</div>
				</div>
			</div>
		</div>
