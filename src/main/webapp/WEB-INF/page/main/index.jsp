    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="javascript:void(0)" class="navbar-brand"> <small>
                <i class="icon-leaf"></i> 今捷商学院教务管理系统
            </small>
            </a>
            <!-- /.brand -->
        </div>
            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                                          class="dropdown-toggle"> <img class="nav-user-photo"
                                                                        src="res/assets/avatars/user.jpg" alt="Jason's Photo" /> <span
                        class="user-info"> <small>欢迎光临, ${staff.roleName} ${staff.staffName }</small>
						</span> <i class="icon-caret-down"></i>
                </a>
                    <ul
                            class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">

                        <li><a href="staff.do" target="mainframe"> <i class="icon-user"></i>
                            个人资料
                        </a></li>
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <li class="active"><a href="bootm.do" target="mainframe">
                    <i class="icon-dashboard"></i> <span class="menu-text">
								控制台 </span>
                </a></li>
                <c:forEach items="${menulist }" var="menu">
                    <c:if test="${menu.parent_menu_id==0 }">
                        <li><a href="javascript:void(0)" target="mainframe"
                               class="dropdown-toggle"> <i class="icon-desktop"></i> <span
                                class="menu-text"> ${menu.menu_name } </span> <b
                                class="arrow icon-angle-down"></b>
                        </a>

                            <ul class="submenu">
                                <c:forEach items="${menulist }" var="submenu">
                                    <c:if test="${menu.menu_id==submenu.parent_menu_id }">
                                        <li><a href="${submenu.menu_url }" target="mainframe"> <i
                                                class="icon-double-angle-right"></i> ${submenu.menu_name }
                                        </a></li>
                                    </c:if>
                                </c:forEach>
                            </ul></li>
