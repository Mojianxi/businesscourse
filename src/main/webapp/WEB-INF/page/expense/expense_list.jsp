...
<form action="expense/list.do" method="post" id="f1"
        ...
        <table class="table ">
            ...
            <c:forEach items="${list }" var="exp">
                <tr>
                    ...
                    <td>${exp.expenseState==-5?'<a href="javascript:void(0)" class="btn btn-danger btn-xs">报销单作废</a>':''}
                            ${exp.expenseState==0?'<a href="javascript:void(0)" class="btn btn-info btn-xs">报销单未提交</a>':''}
                    ...
                    <th><a href="expense/show.do?expenseId=${exp.expenseId }">查看明细</a></th>
                </tr>
            </c:forEach>
    ...
    <div align="right" style="padding: 10px;">
        <pg:pager items="${total }" url="expense/list.do"
